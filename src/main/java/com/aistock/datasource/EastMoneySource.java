...
/**
 * {@link DataSource} backed by {@link EastMoneyClient} for fetching A-share
 * daily bars and a {@link BarCache} for persistence.
 *
 * <p>Update strategy mirrors {@link YahooSource}:
 * <ul>
 ...
 * </ul>
 */
public class EastMoneySource implements DataSource {
    ...
    public EastMoneySource(EastMoneyClient client, BarCache cache) {
        this.client = client;
        this.cache = cache;
    }
